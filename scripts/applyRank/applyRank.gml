...
if(rank >= 2){
	...
	if(class == 1){ player.skillJumpShot2 = true; }
	...
	if(class == 7){ player.skillMultiJump2 = true; player.bombsMax = 5;}
	if(class == 8){ player.skillMultiToss = true;}
	if(class == 9){ player.skillSlowAura2 = true; player.skillWallSlide = true; }
...
if(rank >= 3){
	...
	if(class == 1){ player.skillMultiJump2 = true; player.skillShield = true;}
	...
	if(class == 7){ player.tossCDMax = 5; player.bombsMax = 5; player.skillWallSlide = true;}
